...
export class Item {
  constructor(
    ...
    public readonly rangedAim: number,
    public readonly rangedPower: number,
    public readonly magicAim: number,
    ...
    public readonly requiredRangedLevel: number,
    public readonly requiredMagicLevel: number,
