...
namespace RavenNest.BusinessLogic.Game.Processors.Tasks
{
    public abstract class ResourceTaskProcessor : PlayerTaskProcessor
    {
        ...
        protected const double DropChanceIncrement = 0.0025;
        ...
        static ResourceTaskProcessor()
        {
            ...
            {
                new ResourceDrop(Guid.Parse("49D53A1E-55F7-4537-9A5B-0560B1C0F465"), "Ethereum", 0.0035, 280),
                new ResourceDrop(Guid.Parse("BA6ED0AD-2FE6-46BF-9A99-5528657FF40E"), "Lionite", 0.0055, 240),
                ...
                new ResourceDrop(Guid.Parse("40781EB8-1EBF-4C0C-9A11-6E8033C9953C"), "Rune Nugget", 0.1, 70),
